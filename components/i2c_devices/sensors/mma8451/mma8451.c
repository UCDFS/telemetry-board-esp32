...
struct mma8451_reg_status {
	bool XDR  :1; // STATUS<0>   X axis new data ready
	bool YDR  :1; // STATUS<1>   Y axis new data ready
	bool ZDR  :1; // STATUS<2>   Z axis new data ready
	bool ZYXDR:1; // STATUS<3>   X, Y and Z axis new data ready
	bool XOW  :1; // STATUS<4>   X axis data overwrtie
	bool YOW  :1; // STATUS<5>   Y axis data overwrite
	bool ZOW  :1; // STATUS<6>   Z axis data overwrite
	bool ZYXOW:1; // STATUS<7>   X, Y and Z axis data overrun
};
...
esp_err_t mma8451_set_mode(mma8451_handle_t dev, mma8451_oversampling_mode_t oversampling_mode, mma8451_data_rate_t data_rate, bool low_noise, bool fast_read) {
